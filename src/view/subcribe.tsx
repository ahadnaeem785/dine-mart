...
export default function Subcribe() {
    return (
        <div className="mb-[180px] px-8 lg:px-20">
            <div className='flex flex-col flex-wrap  justify-center items-center relative'>
                <h2 className="scroll-m-20 text-center mt-2 pb-2 text-4xl font-bold tracking-tight first:mt-0">
                ...
                <div className="flex flex-col lg:flex-row gap-y-4 lg:gap-y-0 mt-3 lg:mt-6 w-[80%] lg:w-full max-w-sm items-center space-x-2">
                    ...
                    <Button type="submit" className='h-9 px-6 font-medium'>Get Started</Button>
                </div>
                <h1 className='absolute text-gray-100 mt-6 lg:-mt-3 text-6xl lg:text-[120px] -z-10 font-bold'>
                    Newsletter
                </h1>
