        ...
        <div className='mb-[100px] px-8 lg:px-20'>
            ...
            <div className='flex flex-col lg:flex-row  gap-6 mt-6'>
                <div className='basis-7/12'>
                    <div className='flex justify-between  bg-gray-300 pt-6 lg:pt-0'>
                        <div className='flex flex-col justify-center ml-6 '>
                            <h2 className=' text-2xl lg:text-3xl font-bold -mt-2 lg:-mt-0'>GET UP TO <span className='text-3xl font-bold'>60%</span></h2>
