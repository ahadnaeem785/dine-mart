        ...
        <div className=''>
            <div className='px-8 lg:px-20 grid grid-cols-1 lg:grid-cols-4 gap-x-12 gap-y-8 border-b pb-32 border-gray-800'>
                ...
                <div className='lg:pl-[120px]'>
                    ...
                    <ul className="flex text-left text-base flex-col mt-4 space-y-3 ">
                        <li>About</li>
                        <li>Terms of Use</li>
            ...
            {/* bottom content */}
            <div className=' flex flex-col lg:flex-row gap-y-4 px-8 justify-around my-4 text-base'>
                <p className='text-gray-500'>Copyright © 2022 Dine Market</p>
                <p className='text-gray-500'>Design by. <span className='font-bold text-gray-800'>Muhammad Ahad</span></p>
                <p className='text-gray-500'>Code by. <span className='font-bold text-gray-800'>ahadnaeem785 on github</span></p>
            </div>
        </div>
    )
}
